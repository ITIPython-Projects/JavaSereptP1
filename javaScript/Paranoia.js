...
var NewParaGameHandler = document.getElementById("ParaNewGame")

NewParaGameHandler.addEventListener("click", function () {
	draw();
	NewParaGameHandler.style.display = "none"
	var imgsrc = '../media/images/paranoia/Gradient.png'
